...
from inference.io import Readhdf5, Readhdf5_mc
...
print('-----')
print(((1.76 - 3) ** 2) ** 0.5 - abs(1.76 - 3))
with Readhdf5(fnameM, show_metadata=False) as f:
    true_model = f.read_single_dataset('TrueModels', 'T=1.00')
    inf_model = f.read_single_dataset('InferredModels:0', 'T=1.00')
